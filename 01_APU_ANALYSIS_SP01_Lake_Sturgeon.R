...
write_csv(s_cost, "APU/output/summary_costs_SP01.csv")
write_csv(s_repr, "APU/output/summary_targets_SP01.csv")
...
write_sf(pu_sf, "APU/output/APU_solutions_SP01.shp")
saveRDS(s, "APU/output/APU_solutions_SP01.rds")
...
# ggsave("APU/figures/APU_solutions_map_SP01.png", g, width = 15, height = 15)
