...
# read solutions
s <- readRDS("APU_17/output/APU_solutions.rds")
...
write_csv(species_targets_spread, "APU_17/results/APU17_representation_targets_by_species.csv")


# SUMMARIZE AREAS
# read planning units geometries
pu_sf <- read_sf("APU_17/output/APU_solutions.shp")
...
# write_csv(pu_solutions, "APU_17/output/APU_solutions.csv")
...
# Write table as csv
output_table <- write_csv(solution_table, "APU_17/results/APU17_area_summary.csv")

# read in the summary targets table
summary_targets <- read_csv("APU_17/output/summary_targets.csv") %>%
...
# write output
output_table <- write_csv(join_table, "APU_17/results/APU17_area_targets_summary.csv")
