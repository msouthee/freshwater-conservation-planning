...
write_csv(s_cost, "APU/output/summary_costs.csv")
write_csv(s_repr, "APU/output/summary_targets.csv")
...
write_sf(pu_sf, "APU/output/APU_solutions.shp")
saveRDS(s, "APU/output/APU_solutions.rds")
