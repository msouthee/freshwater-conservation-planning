...
write_csv(pu_solutions, "APU/output/APU_solutions_SP01.csv")
...
# Write table as csv
output_table <- write_csv(solution_table, "APU/results/APU_area_summary_SP01.csv")

# read in the summary targets table
summary_targets <- read_csv("APU/output/summary_targets_SP01.csv")

# join targets and areas table
join_table = inner_join(solution_table, summary_targets, by = 'target')

# write output
output_table <- write_csv(join_table, "APU/results/APU_area_targets_summary_SP01.csv")
