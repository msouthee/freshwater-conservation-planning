...
write_csv(s_cost, "APU_30/output/summary_costs.csv")
write_csv(s_repr, "APU_30/output/summary_targets.csv")
...
write_sf(pu_sf, "APU_30/output/APU_solutions.shp")
saveRDS(s, "APU_30/output/APU_solutions.rds")
