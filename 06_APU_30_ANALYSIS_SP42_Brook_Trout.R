...
target_levels <- data_frame(target = seq(0.30, 0.40, 0.01))
...
write_csv(s_cost, "APU_30/output/summary_costs_SP42.csv")
write_csv(s_repr, "APU_30/output/summary_targets_SP42.csv")
...
write_sf(pu_sf, "APU_30/output/APU_solutions_SP42.shp")
saveRDS(s, "APU_30/output/APU_solutions_SP42.rds")
