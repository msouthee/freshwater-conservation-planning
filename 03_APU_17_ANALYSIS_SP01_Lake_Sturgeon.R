...
write_csv(s_cost, "APU_17/output/summary_costs_SP01.csv")
write_csv(s_repr, "APU_17/output/summary_targets_SP01.csv")
...
write_sf(pu_sf, "APU_17/output/APU_solutions_SP01.shp")
saveRDS(s, "APU_17/output/APU_solutions_SP01.rds")
