...
write_csv(s_cost, "APU/output/summary_costs_SP09.csv")
write_csv(s_repr, "APU/output/summary_targets_SP09.csv")
...
write_sf(pu_sf, "APU/output/APU_solutions_SP09.shp")
saveRDS(s, "APU/output/APU_solutions_SP09.rds")
...
# ggsave("APU/figures/APU_solutions_map_SP09.png", g, width = 15, height = 15)
