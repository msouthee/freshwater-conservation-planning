...
write_csv(s_cost, "APU_17/output/summary_costs.csv")
write_csv(s_repr, "APU_17/output/summary_targets.csv")
...
write_sf(pu_sf, "APU_17/output/APU_solutions.shp")
saveRDS(s, "APU_17/output/APU_solutions.rds")
