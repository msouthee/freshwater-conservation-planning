...
write_csv(s_cost, "APU_30/output/summary_costs_PAs.csv")
write_csv(s_repr, "APU_30/output/summary_targets_PAs.csv")
...
write_sf(pu_sf, "APU_30/output/APU_solutions_PAs.shp")
saveRDS(s, "APU_30/output/APU_solutions_PAs.rds")
