...
target_levels <- data_frame(target = seq(0.10, 0.20, 0.01))
...
write_csv(s_cost, "APU_17/output/summary_costs_PAs.csv")
write_csv(s_repr, "APU_17/output/summary_targets_PAs.csv")
...
write_sf(pu_sf, "APU_17/output/APU_solutions_PAs.shp")
saveRDS(s, "APU_17/output/APU_solutions_PAs.rds")
