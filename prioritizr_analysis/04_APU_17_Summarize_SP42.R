...
# write_csv(pu_solutions, "APU_17/output/APU_solutions_SP42.csv")
...
# Write table as csv
output_table <- write_csv(solution_table, "APU_17/results/APU17_area_summary_SP42.csv")

# read in the summary targets table
summary_targets <- read_csv("APU_17/output/summary_targets_SP42.csv") %>%
...
# write output
output_table <- write_csv(join_table, "APU_17/results/APU17_area_targets_summary_SP42.csv")
