...
pu_sf <- read_sf("APU_17/output/APU_solutions_SP01.shp")
...
g <- ggplot(pu_map_soln) +
  ...
  labs(title = "Selected planning units to protect 17% of study area under current climate scenarios",
       fill = NULL) +
...
# save map SP01
ggsave("APU_17/figures/APU_final_solution_map_SP01.png", g, width = 15, height = 15)



# LOAD SOLUTIONS FOR SP09
# read planning units geometries
pu_sf <- read_sf("APU_17/output/APU_solutions_SP09.shp")
...
# save map SP09
ggsave("APU_17/figures/APU_final_solution_map_SP09.png", g, width = 15, height = 15)



# LOAD SOLUTIONS FOR SP42
# read planning units geometries
pu_sf <- read_sf("APU_17/output/APU_solutions_SP42.shp")
...
# save map SP42
ggsave("APU_17/figures/APU_final_solution_map_SP42.png", g, width = 15, height = 15)



# LOAD SOLUTIONS FOR SP46
# read planning units geometries
pu_sf <- read_sf("APU_17/output/APU_solutions_SP46.shp")
...
# save map SP46
ggsave("APU_17/figures/APU_final_solution_map_SP46.png", g, width = 15, height = 15)