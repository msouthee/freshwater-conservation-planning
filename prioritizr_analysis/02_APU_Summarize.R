...
write_csv(species_targets_spread, "APU/results/APU_representation_targets_by_species.csv")
...
write_csv(pu_solutions, "APU/output/APU_solutions.csv")
...
# Write table as csv
output_table <- write_csv(solution_table, "APU/results/APU_area_summary.csv")

# read in the summary targets table
summary_targets <- read_csv("APU/output/summary_targets.csv")

# join targets and areas table
join_table = inner_join(solution_table, summary_targets, by = 'target')

# write output
output_table <- write_csv(join_table, "APU/results/APU_area_targets_summary.csv")
