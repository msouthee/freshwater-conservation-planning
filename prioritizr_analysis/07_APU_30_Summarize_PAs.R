...
write_csv(species_targets_spread, "APU_30/results/APU30_representation_targets_by_species_PAs.csv")
...
# write_csv(pu_solutions, "APU_30/output/APU_solutions_PAs.csv")
...
# Write table as csv
output_table <- write_csv(solution_table, "APU_30/results/APU30_area_summary_PAs.csv")

# read in the summary targets table
summary_targets <- read_csv("APU_30/output/summary_targets_PAs.csv") %>%
...
# write output
output_table <- write_csv(join_table, "APU_30/results/APU30_area_targets_summary_PAs.csv")
