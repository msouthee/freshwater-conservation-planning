...
# read solutions
s <- readRDS("APU_30/output/APU_solutions.rds")
...
write_csv(species_targets_spread, "APU_30/results/APU30_representation_targets_by_species.csv")


# SUMMARIZE AREAS
# read planning units geometries
pu_sf <- read_sf("APU_30/output/APU_solutions.shp")
...
# write_csv(pu_solutions, "APU_30/output/APU_solutions.csv")
...
# Write table as csv
output_table <- write_csv(solution_table, "APU_30/results/APU30_area_summary.csv")

# read in the summary targets table
summary_targets <- read_csv("APU_30/output/summary_targets.csv") %>%
...
# write output
output_table <- write_csv(join_table, "APU_30/results/APU30_area_targets_summary.csv")
