...
write_csv(s_cost, "APU_30/output/summary_costs_SP09.csv")
write_csv(s_repr, "APU_30/output/summary_targets_SP09.csv")
...
write_sf(pu_sf, "APU_30/output/APU_solutions_SP09.shp")
saveRDS(s, "APU_30/output/APU_solutions_SP09.rds")
