...
# write_csv(pu_solutions, "APU_30/output/APU_solutions_SP01.csv")
...
# Write table as csv
output_table <- write_csv(solution_table, "APU_30/results/APU30_area_summary_SP01.csv")

# read in the summary targets table
summary_targets <- read_csv("APU_30/output/summary_targets_SP01.csv") %>%
...
# write output
output_table <- write_csv(join_table, "APU_30/results/APU30_area_targets_summary_SP01.csv")
